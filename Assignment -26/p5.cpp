...
class Item
{
    ...
    public:
        ...
        friend void f1(Item xyz);  // Friend Function decleare
    ...
    /*  "f1(i1)" a "f1" holo friend function, and "i1" holo 
        ...
        (Item) type likhta hobe, tar pase ja hok nam dilau 
        cholbe abr na dilau cholbe   */
...
/* Friend Function needs an object to access it's properties or methods 
    ...
    jamon akena "f1" friend function "i1" object ke use kore property golo use korta pare
